...
const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-950 text-slate-300">
      {/* Sponsors Band (se mantiene clara, pero separada del cierre) */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="md:col-span-5">
            <img
              ...
              alt="JIF 2026"
              className="h-16 w-auto mb-8 brightness-0 invert opacity-95"
              loading="lazy"
            />

            <h3 className="text-white font-black text-lg mb-4 leading-tight uppercase tracking-tight">
              IX Jornadas Ibéricas de Fotoquímica & II Franco-Iberian Conference on Photochemistry
            </h3>

            <p className="text-slate-300/80 text-sm leading-relaxed max-w-md font-medium">
            ...
            {/* Micro badge espectral */}
            <div className="mt-8 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-4 py-2">
          ...
          <div className="md:col-span-4 grid grid-cols-2 gap-10">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-[13px] font-medium">
                ...
                <li>
                  <Link to="/committees/international" className="text-slate-300/80 hover:text-white transition-colors">
                    Committees
                  </Link>
                </li>
              </ul>
